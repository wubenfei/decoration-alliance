...
public class RequestHeadFilter implements Filter{
    ...
    public void TotalFilter() {
        allowOrigin.add("http://127.0.0.1:8081");
        allowOrigin.add("http://192.168.10.69:8081");
    }
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (allowOrigin.contains(origin)) {
            ...
            httpServletResponse.setHeader("Access-Control-Allow-Origin", "http://192.168.10.69:8081");
        }
